...
function showError(input, message) {
    const inputGroup = input.closest('.input-group') || input.closest('.terms');
...
passwordInput.addEventListener('input', function() {
    ...
    // Re-validate confirm password if it has value
    if (confirmPasswordInput.value && (confirmPasswordInput.classList.contains('error') || confirmPasswordInput.classList.contains('success'))) {
        const confirmError = validateConfirmPassword(this.value, confirmPasswordInput.value);
        if (confirmError) {
            showError(confirmPasswordInput, confirmError);
        } else {
